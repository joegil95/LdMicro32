...
CD lib
for %%F in (*.c) do  picc.exe --pass1 %%F -q --chip=16F876 -P --runtime=default --opt=default -g --asmlist --OBJDIR=../obj
CD ..

picc.exe --pass1 %~nx2.c -q --chip=16F876 -P --runtime=default --opt=default  -g --asmlist --OBJDIR=obj

REM Linkage des objets
picc.exe -obin\%~nx2.cof -mbin\%~nx2.map --summary=default --output=default obj/*.p1 --chip=16F876 -P --runtime=default --opt=default -g --asmlist --OBJDIR=obj --OUTDIR=bin
